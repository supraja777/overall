...
const ExecutiveTop = () => (
  <div style={styles.container}>
    ...
    <div style={styles.textContainer}>
      <span style={styles.status}>OVERALL_VERDICT</span>
      <p style={styles.description}>Candidate is <span style={styles.highlight}>97% strong</span> for this role.</p>
    </div>
  </div>
);
